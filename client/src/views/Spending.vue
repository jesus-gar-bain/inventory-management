...
/* Chart series colors: no direct token match for these hues (violet/emerald/amber) */
...
.y-axis {
  ...
  font-size: 0.75rem;
  color: #94a3b8; /* light-surface muted tint; no token matches (text-on-dark-muted is for dark bg only) */
...
/* Sticky header while scrolling the transactions list; not part of the global table styling */
...
/* Rows are clickable here (unlike most global tables), so cursor + a distinct hover tint are kept */
