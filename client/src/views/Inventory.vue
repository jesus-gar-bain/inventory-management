...
<style scoped>
/* .page-header, .card-header, .card-title removed: identical to App.vue globals */
...
.search-input {
  width: 100%;
  /* 2.5rem side padding kept literal (functional icon clearance, not decorative spacing) */
