          ...
          <table>
            ...
            <tbody>
              <tr v-for="item in backlogItems" :key="item.id">
                ...
                <td>
                  <span :class="item.days_delayed > 7 ? 'days-delayed-severe' : 'days-delayed-warning'">
...
<style scoped>
/* Empty-state and days-delayed colors moved from inline styles to tokenized classes */
.empty-state {
  padding: var(--space-8);
  text-align: center;
}
