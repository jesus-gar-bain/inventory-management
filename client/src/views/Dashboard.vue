...
<style scoped>
/* NOTE: local .page-header override only adds flex layout for a meta slot;
   spacing/typography still inherits from the global rule in App.vue */
.page-header {
  display: flex;
...
/* Chart geometry unchanged — only fills below map to design tokens */
.donut-center-label {
  font-size: 12px;
  fill: var(--text-muted);
  font-weight: 500;
